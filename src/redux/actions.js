import {
  ...
  TRIP_COST_CHANGED, HISTORY_DETAILS, SET_PAYMENT_METHOD, RIDER_DETAILS,RECIPIENT_PHONE_ADDED,RECIPIENT_NAME_ADDED,GET_RIDER_COORDS, TRIPS_UPDATED
} from "./actionTypes";
...
export const tripsUpdated = (trips) => {
  return {
    type: TRIPS_UPDATED,
    trips
  }
